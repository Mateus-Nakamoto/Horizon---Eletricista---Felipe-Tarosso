    ...
    <footer className="bg-secondary text-secondary-foreground">
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/share/17bRXzSona/" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-primary transition-all duration-200 group">
                <Facebook className="w-5 h-5 text-secondary-foreground group-hover:text-primary-foreground" />
              </a>
              <a href="https://www.instagram.com/_tarosso_/" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-primary transition-all duration-200 group">
        ...
        <div className="text-lg">
          <p className="text-secondary-foreground/100 ml-12">
            Website produzido pela{" "}
            <a
              href="https://www.nihondigital.com.br"
              target="_blank"
